...
#define SI7021_SDAIN()      do{P1IO &= ~SI7021_SDA_NUMBER;}while(0)
#define SI7021_SDAOUT()      do{P1IO |= SI7021_SDA_NUMBER;}while(0)
...
#define  SI7021_SCL_HIGH()  do{SI7021_SCL = BIT_HIGH;}while(0)
#define  SI7021_SCL_LOW()  do{SI7021_SCL = BIT_LOW;}while(0)

#define  SI7021_SDA_HIGH()  do{SI7021_SDA = BIT_HIGH;}while(0)
#define  SI7021_SDA_LOW()  do{SI7021_SDA = BIT_LOW;}while(0)
